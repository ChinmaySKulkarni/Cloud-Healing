...
\input{abstract.tex}		% Abstract: Independently typeset in file abstract.tex
...
\input{chapter_1_Introduction.tex}		% Add each chapter here in this fashion.
				% No need to write all font and page specs in the chapter
				% files. There only typesetting tags are required.
\input{chapter_2_layered_architecture.tex}
\input{chapter_3_healing.tex}		
\input{chapter_4_existing_solutions.tex}
\input{chapter_5_problem_statement.tex}
\input{chapter_6_proposed_solution.tex}
\input{chapter_7_results.tex}
\appendix
\input{appendix_blue_gene.tex}
\input{appendix_apriori.tex}
