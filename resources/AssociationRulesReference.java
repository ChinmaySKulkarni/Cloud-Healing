...
public class AssociationRulesReference {
    ...
    public static void main(String args[]) {
        ...
        AssociationRulesReference associationRules = new AssociationRulesReference(inputText);
    ...
    // constructor
    //
    AssociationRulesReference(String[] inputText) {
